...
typedef ::boost::make_recursive_variant<
    Point, LineString, Polygon, LinearRing, MultiPoint, MultiLineString,
    MultiPolygon, std::vector<boost::recursive_variant_>>::type Geometry;
typedef std::vector<Geometry> GeometryCollection;

typedef ::boost::variant<::boost::blank, Point *, LineString *, Polygon *,
